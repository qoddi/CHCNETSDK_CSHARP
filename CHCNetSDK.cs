...
namespace hikssldemo
{
    ...
    public class CHCNetSDK
    {
        ...
        public struct NET_DVR_ALARMINFO_V40
       {
        ...
        /*********************************************************
        Struct:	NET_DVR_ACTIVATECFG
        Desc:		用户激活设备使用的结构体   addbyqoddi
        ...
        **********************************************************/
        ...
        public struct NET_DVR_ACTIVATECFG
        {
            ...
            public byte[] byReserve;//预留，sizecont=bytes[xxx]
        }

        /*********************************************************
        Struct:	NET_DVR_DEVICEINFO_V30
        Desc:		用户登录设备使用的结构体   addbyqoddi
        typedef struct
        {
        ...
        */
        ...
        Desc:		用户激活设备   addbyqoddi
        Input:	sDVRIP [in] 设备IP地址 
        wServerPort [in] 设备端口号 
        lpActivateCfg [in] 包含设备密码信息结构体 
        Return:	TRUE 表示成功，FALSE 表示失败
        NET_DVR_API BOOL __stdcall NET_DVR_ActivateDevice(char* sDVRIP, WORD wDVRPort, LPNET_DVR_ACTIVATECFG    lpActivateCfg);
        **********************************************************/
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern bool NET_DVR_ActivateDevice(string sDVRIP,Int32 wDVRPort,ref NET_DVR_ACTIVATECFG lpActivateCfg);
